...
readTime: "5 min read"
featured: true
primaryService: "self-assessment-tax-returns"
---
...
| Instalment | Due date (usual) | Amount |
|------------|------------------|--------|
| **First** | 31 January (same year as filing deadline) | 50% of prior year liability |
| **Second** | 31 July | 50% of prior year liability |
...
You may need payments on account if your last Self Assessment bill was **above HMRC's threshold** (check current guidance on [GOV.UK](https://www.gov.uk/understand-self-assessment-bill/payments-on-account)).
...
- Advice for **landlords** and [property accounts](/services/property-accounts/)

[Contact us](/contact/) for a free consultation, or explore our [Self Assessment tax returns](/services/self-assessment-tax-returns/) service.
